...
export default function Footer() {
  ...
  return (
    <footer className="bg-secondary-300 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="text-sm text-neutral-300 dark:text-neutral-400">
              <Link
                ...
                className="text-neutral-300 dark:text-neutral-400 hover:text-primary-300 hover:underline transition duration-150 ease-in-out"
              >
                Security
              </Link>{" "}
              ·{" "}
              ...
              <ul className="text-sm">
                {section?.links?.map((link, linkIndex) => (
                  <li key={linkIndex} className="mb-2">
                    <Link
                      href={link.url}
                      className="text-[#e6e2d4] dark:text-gray-300 hover:text-[#ff914d] transition duration-150 ease-in-out"
                    >
                      {link.text}
                    </Link>
                  </li>
          ...
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-3">
            <h6 className="text-primary-300 dark:text-orange-400 font-medium mb-2">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="text-sm text-neutral-300 dark:text-neutral-400 mr-4">
