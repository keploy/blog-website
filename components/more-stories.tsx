...
export default function MoreStories({
  ...
  const loadMorePosts = async () => {
    ...
    try {
      // Just show more if we already have posts
      ...
      // Fetch more ONLY if not searching
        ...
        <div className="flex w-full mb-8">
          <div className="relative w-full">
            <input
              ...
              className="w-full p-3 pl-10 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
