...
export default function HeroLatestCard({ post, isAnimating }: HeroLatestCardProps) {
  ...
  return (
    <div
      className={`bg-green-50 rounded-xl p-4 border-2 border-green-200 relative overflow-hidden transition-all duration-500 ${
        isAnimating ? "scale-95 opacity-50" : "scale-100 opacity-100"
      }`}
    >
      <div className="absolute top-0 right-0 w-24 h-24 bg-green-200/30 rounded-full -mr-12 -mt-12" />
      <div className="relative">
        <div className="text-xs text-green-700 font-mono mb-3">latest.json</div>
