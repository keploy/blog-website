...
const NotFoundPage = ({ latestPosts }: NotFoundPageProps) => {
          ...
          <div className="flex-1 lg:pr-12 mb-6 lg:mb-0">
            ...
            <div className="flex flex-col items-start gap-4">
              ...
              <p className="text-sm text-gray-500 italic">
                Wait for {formatTime(countdown)} for automatic redirect or click the button above or explore our latest blog posts below.
              </p>
            </div>
          </div>
