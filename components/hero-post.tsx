...
export default function HeroPost({
  ...
  return (
    <section>
      <div className="relative bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-600 px-8 py-8 rounded-md lg:grid lg:grid-cols-2 lg:gap-x-8 mb-20 md:mb-28 content-center lg:group transition-all duration-500 hover:border-orange-500 hover:shadow-[0_0_10px_2px_rgba(255,165,0,0.6)] overflow-hidden">
        {/* Banner */}
        ...
        <div className="">
          <div>
            <h3 className="heading1 text-4xl lg:text-6xl font-bold leading-none dark:text-white">
              <Link
                href={`${basePath}/${slug}`}
