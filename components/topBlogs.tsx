...
const TopBlogs = ({ communityPosts, technologyPosts }) => {
  return (
    <section className="py-12 px-4 md:px-8 lg:px-16 ">
      <div className="mb-16">
        <h3 className="relative text-center lg:text-left bg-gradient-to-r from-orange-200 to-orange-100 bg-[length:100%_20px] bg-no-repeat bg-left-bottom w-max mb-6 text-3xl lg:text-4xl heading1 md:text-4xl font-bold tracking-tighter leading-tight mt-16">
