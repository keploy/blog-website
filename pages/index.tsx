  ...
  return (
    ...
    >
      <Head>
        ...
        <link rel="preload" href="/blog/images/blog-bunny.png" as="image" />
        {/* Inline critical CSS */}
        <style>{`
          .heading1 {
            font-weight: 700;
        ...
        <div className="">
          <div className="home-container md:mb-0 mb-4 flex lg:flex-nowrap flex-wrap-reverse justify-evenly items-center">
            <div className="content">
              <h2 className="heading1">Keploy Blog</h2>
...
export const getStaticProps: GetStaticProps = async ({ preview = false }) => {
  const [communityPostsData, technologyPostsData] = await Promise.all([
    getAllPostsForCommunity(preview),
    getAllPostsForTechnology(preview),
  ]);

  const communityPosts = communityPostsData?.edges?.slice(0, 3) || [];
  const technologyPosts = technologyPostsData?.edges?.slice(0, 3) || [];
