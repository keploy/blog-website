          ...
          <div className="home-container md:mb-0 mb-4 flex lg:flex-nowrap flex-wrap-reverse justify-evenly items-center">
            <div className="content">
              ...
              <div className="btn-wrapper flex flex-wrap gap-4 mt-6 ">
                <Link
                    href="/technology"
                    className="relative px-4 py-1 overflow-hidden transition-all border border-black dark:border-white 
                              md:text-xl 2xl:text-2xl md:px-8 md:py-2 
                              ...
                              before:h-full before:w-0 before:bg-orange-400 before:transition-all before:duration-250 
                              rounded-xl text-black dark:text-white hover:text-white hover:before:left-0 hover:before:w-full"
                  >
                  ...
                  <Link
                    href="/community"
                    className="relative px-4 py-1 overflow-hidden transition-all border border-black dark:border-white 
                              active:scale-95 md:text-xl 2xl:text-2xl md:px-8 md:py-2 
                              hover:border-orange-400 dark:hover:border-orange-400 
                              before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 
                              before:h-full before:w-0 before:bg-orange-400 before:transition-all before:duration-250 
                              rounded-xl text-black dark:text-white hover:text-white hover:before:left-0 hover:before:w-full"
